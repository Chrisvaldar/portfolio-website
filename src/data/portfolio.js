export const identity = {
  ...
  tagline: [
    ...
    'Full-stack web apps, plus the ML and agent work around them.',
  ],
  skills: [
    'Python',
    'TypeScript',
...
export const workExperience = [
  {
    ...
    org: 'Coco (Startmate Winter 2026)',
    location: 'Melbourne, VIC',
    dates: 'Aug 2026 to Present',
    bullets: [
      'Shipped a TypeScript guardrail layer into Coco’s product path in Startmate’s 12-week program. Policy check and evidence log on agent tool calls.',
      'Mapped 4 customer use-case flows, AML first. Ran 10+ prospect demos and turned objections into product tickets.',
    ],
    github: null,
  ...
  },
  {
    ...
    org: 'Ctrl+Alt+Prebunk (MOSAIC × IFRC / Solferino Academy)',
    location: 'Melbourne, VIC',
    dates: 'Aug 2026 to Present',
    bullets: [
      'Own the in-app chatbot UX. 5-state conversational onboarding as a React/TypeScript state machine, with branching replies, typing indicators, and an in-chat practice post. Localised to 6 languages, including RTL Arabic.',
  ...
  },
  {
    id: 'pulse',
    role: 'AI Engineer',
    org: 'Monash DeepNeuron — Pulse',
    location: 'Melbourne, VIC',
    dates: 'Aug 2026 to Present',
    bullets: [
      'Trained a ResNet18 + LSTM classifier on 16-frame, 224×224 aligned face clips (478-point mesh) to score patient pain from live video.',
      'Streamlit dashboard streams scores in real time and notifies carers when pain stays above threshold.',
